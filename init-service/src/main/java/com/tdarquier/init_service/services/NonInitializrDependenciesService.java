...
@Service
public class NonInitializrDependenciesService {
    ...
    final
    RdfParserService rdfParserService;

    public NonInitializrDependenciesService(RdfParserService rdfParserService) {
